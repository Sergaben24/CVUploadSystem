    ...
    <body style="margin: 0 0 120px;">
        ...
        <div class ="container-fluid" id="containerFluid" >
            <div class="container-fluid">
                ...
                <form action="tryConnectionDatabase.php" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-5 col-lg-4">
                        <div class="Content inputValue">
                            ...
                            <div class="container-fluid" id="submitButton">
                                <!--<a href="#" id="submitLink">--><button type="submit" onclick= "javascript:window.location='../index.php' " class="btn btn-success center-block" id="StudentSubmit"><input type="submit">Submit</button><!--</a>-->
